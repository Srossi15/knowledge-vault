...
export async function generateQuizQuestions(articleId, articleTitle, articleContent) {
  ...
  const prompt = `You are a quiz master creating multiple choice questions to help someone memorize key facts and data from articles about current affairs and global trends.
...
1. Ask about SPECIFIC FACTS, DATA, and STATISTICS from the article
2. Questions should be STANDALONE - do NOT reference the article ("According to...", "In this article..."). Ask as if testing general knowledge.
3. Focus on memorable facts the reader should retain: percentages, rankings, country names, industry details, economic data, policy positions
4. Make questions fluid and conversational - the kind someone would be asked in a discussion
5. For each question, create exactly 4 plausible options (A, B, C, D)
6. One option must be correct, three must be wrong but reasonable
7. Difficulty levels: mix of 1 (easy), 2 (medium), 3 (hard)

EXAMPLES OF GOOD QUESTIONS:
- "What percentage of Southeast Asia's GDP comes from semiconductor manufacturing?"
- "Which country is the world's largest producer of microchips?"
- "What is the main economic risk when a region over-specializes in a single industry?"
- "What was Britain's immigration policy change regarding salary thresholds?"

EXAMPLES OF BAD QUESTIONS:
- "According to the article, what..."
- "In this article, why does..."
